...
describe('driver.setPointPosition', () => {
    ...
    for (let i = 0; i < 15; i++) {
        ...
        it(`Set random point position: ${pointPosition}`, () => {
            ...
            const currentPos: number = parseInt(packet.points[0].css('bottom'));        
...
describe('driver.updateTooltip', () => {
    ...
    for (let i = 0; i < 20; i++) {
        ...
        it(`Set random tooltip position and random size: ${pointPosition} ${tooltipSize}`, () => {
            ...
            const currentPos: number = parseInt(packet.tooltips[0].css('bottom'));                        
    ...
    describe('1 point', () => {
        for (let i = 0; i < 20; i++) {
            ...
            it(`Set random position: ${pointPosition}`, () => {
                ...
                expect(Math.abs(
                    packet.bgLine.height() - (sliderSize * pointPosition)
                ) < 1).to.be.true;
            });
        }
    });
